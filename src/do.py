...
def build_java():
    ...
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb5p500.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb8p500.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb3p1000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb5p1000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb8p1000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb3p5000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb5p5000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperimentb8p5000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'DGExperiment.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'dgea.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'dgeab5p500.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'dgeab8p500.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'dgeab3p1000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'dgeab5p1000.java'], verbose=_verbosity)
    run('code-experiments/build/java', ['javac', '-classpath', '.', 'dgeab8p1000.java'], verbose=_verbosity)
...
def test_java():
    ...
    try:
        run('code-experiments/build/java',
            ['java', '-Djava.library.path=.', 'DGExperiment'],
            verbose=_verbosity)
        run('code-experiments/build/java',
            ['java', '-classpath', '.', '-Djava.library.path=.', 'dgea'],
            verbose=_verbosity)
